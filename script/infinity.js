function infinity(){
	...
	if(infinity_confirmation==true){
		if(ExpantaNum(game.normal.number).gte(ExpantaNum(game.infinity.requirement))){
			...
			getAchievement(11);
			if(ExpantaNum(game.infinity.timespent).lt(0.25)&&game.infinity.hasinfinitied) getAchievement(21);
		}
		...
		if(game.infinity.upgrades[4]||game.eternity.milestones[5]) game.normal.number=10;
